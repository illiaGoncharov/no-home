    ...
    <div class="container-fluid">
        <div class="row nav-top-content">
            ...
            <div id="horseIndicator" class="horse-indicator col-xxl-3 col-xl-3 col-lg-4 col-md-4 col-sm-5">
                ...
                <img src="https://nohome.cloud/wp-content/themes/blankslate/files/nav/display.png" alt="Display">

				<button id="close-hi"></button>
                <div class="horse-indicator-wrapper">
                    <div class="horse-indicator-text-wrapper">
                        <div class="horse-indicator-text" id="hi-update">The horse will lead you throughout the place</div>						
                    </div>
				</div>
				</div>
                ...
                <img src="https://nohome.cloud/wp-content/themes/blankslate/files/nav/player.png" alt="Display">
                ...
                <div class="horse-indicator-player">
					...
					<div class="horse-indicator-song">
						...
						<div class="horse-indicator-song-now marquee-content">floating into</div>
						</div>
						<div class="horse-indicator-song-time">00:00</div>
					</div>
                    <div class="horse-indicator-song-hashtag">#WEB_SURFING</div>						
                </div>
