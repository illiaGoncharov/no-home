...
<div class="iphone-container">
  ...
  <div class="lockscreen">
   ...
   <button id="notification"><img class="iphone-notification" src="https://nohome.cloud/wp-content/themes/blankslate/files/items/iphone/notification.png"></button>
   <div id="date"></div>
   <div id="time"></div>
  ...
  <div class="left-emoji"><ul id="emoji">
