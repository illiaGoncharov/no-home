...
function initializeBedroomInteractions() {
    ...
    elements.backpackOverlay.addEventListener('click', () => {
        toggleVisibility(elements.bedroomMain, elements.backpackInBedroomRoom)
    });

    elements.suitcaseOverlay.addEventListener('click', () => {
    ...
    buttons.arrowLeftBackpackBedroom.addEventListener('click', () => toggleVisibility(elements.backpackInBedroomRoom, elements.bedroomMain));
    buttons.arrowLeftSuitcaseBedroom.addEventListener('click', () => toggleVisibility(elements.suitcaseInBedroomRoom, elements.bedroomMain));
...
elements.outsideOverlay.addEventListener('mouseenter', () => {
    ...
    sounds.outsideSound.volume = 0; // Устанавливаем начальную громкость в 0
    sounds.outsideSound.play();
    fadeInVolume(sounds.outsideSound, 0.5, 1800); // Плавно увеличиваем громкость до 0.5 за 3С
});
...
elements.outsideOverlay.addEventListener('click', () => {
    applyVolumeToSound(sounds.outsideSound, 1); // Применяем громкость на 100%
...
buttons.arrowLeftOutsideBedroom.addEventListener('click', () => {
...
elements.silhouetteOverlay.addEventListener('mouseenter', () => {
    elements.silhouette.style.transition = 'opacity 1s';
    elements.silhouette.style.opacity = '1';
});

elements.silhouetteOverlay.addEventListener('mouseleave', () => {
    elements.silhouette.style.opacity = '0';
});

elements.silhouetteOverlay.addEventListener('click', () => {
    applyVolumeToSound(sounds.lullabySound, 1); // Применяем громкость на 100%
...
document.addEventListener('DOMContentLoaded', initializeBedroomInteractions);
</script>
